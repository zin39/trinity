    ...
    .img-container span, .img-container-mini span {
            ...
            <script>
                        ...
                        dictInvalidFileType: "<?php echo trans('Error_extension'); ?>",
                                ...
                                dictDefaultMessage: "<?php echo trans('Drop file here to upload'); ?>",
            ...
            <?php if ($upload_files) { ?>
                ...
                <div class="uploader">
                    <div class="text-center">
                        <button class="btn btn-inverse close-uploader"><i class="icon-backward icon-white"></i> <?php echo trans('Return to files list') ?></button>
                    </div>
                            ...
                            <div class="tab-content">
                                ...
                                <form action="dialog.php" method="post" enctype="multipart/form-data" id="rfmDropzone" class="dropzone">
                                    ...
                                    <div class="fallback">
                                        ...
                                        <input type="hidden" name="lang" value="<?php echo 'en'; ?>"/>
                                        <input type="hidden" name="filter" value="<?php echo $filter; ?>"/>
                                        <input type="submit" name="submit" value="<?php echo trans('OK') ?>" />
                                    </div>
                                </form>
                                <div class="upload-help"><?php echo trans("Drag & Drop files or click in the area above (modern browsers) and select the file(s). When the upload is complete, click the 'Return to files list' button."); ?></div>
