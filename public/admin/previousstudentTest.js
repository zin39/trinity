    ...
    if (typeof d3 == 'undefined') {
      ...
      return;
        ...
        if(element) {
          ...
          var LastReadinessTestData = $('input[name=LastReadinessTestData]').val();
          var LastPracticeTestData = $('input[name=LastPracticeTestData]').val();
          var LastMockupTestData = $('input[name=LastMockupTestData]').val();
