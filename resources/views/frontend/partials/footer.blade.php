  ...
  <footer class="bg-footer footer-one text-light" style="background-image: url(assets/img/shape/27.png)">
    <div class="container">
      <div class="footer-style-one p-0">
        <div class="row">
          <!-- Singel Item -->
          <div class="col-lg-4 col-md-12 footer-item ">
            <div class="logo text-center">
              <img src="assets/img/footer_logo.png" alt="Image Not Found" width="150" height="150" />
            </div>
            ...
            <!-- <div class="f-item about">
              <div class="logo">
                <img src="assets/img/trnty_logo.png" alt="Image Not Found" />
              </div>
          ...
          <div class="col-lg-4 col-12 ">
            ...
            <ul class="d-flex justify-content-center mt-2">
              <li class="mx-2 social-icon-circle"><a href=""><img src="assets/img/illustration/insta.png"
                    alt="icon"></i></a></li>
              <li class="mx-2 social-icon-circle"><a href=""><img src="assets/img/illustration/facebook.png"
                    alt="icon"></a>
              </li>
              <li class="mx-2 social-icon-circle"><a href=""><img src="assets/img/illustration/linked_in.png"
                    alt="icon"></a>
              </li>
              <li class="mx-2 social-icon-circle"><a href=""><img src="assets/img/illustration/youtube.png"
                    alt="icon"></a></li>
              <li class="mx-2 social-icon-circle"><a href=""><img src="assets/img/illustration/tiktok.png"
                    alt="icon"></a>
              </li>
              <li class="mx-2 social-icon-circle"><a href=""><img src="assets/img/illustration/whatsapp.png"
                    alt="icon"></a>
              </li>
            </ul>
            <div>
        ...
        <div class="row align-items-center py-5">
          <div class="col-lg-7 col-md-10 col-xs-12">
            <div class="d-flex align-items-start">
              <img src="assets/img/shape/joint-comission.png" alt="image" />
          ...
          <div class="col-md-2 col-xs-12 text-end cursor-pointer" id="top">
            <img src="assets/img/shape/arrow-up.png" alt="image" />
          </div>
          <div class="col-lg-3">
            <ul class="d-flex">
  ...
  <script src="assets/custom_js/main.js"></script>
