...
<nav class="site-navbar">
    <div class="navbar-inner">
        ...
        <a href="{{ route('home') }}" class="navbar-brand">
            <img src="{{ asset($setting && $setting->company_logo ? $setting->company_logo : 'frontend-assets/img/thiswebsite_logo_navbar.svg') }}" alt="Karissa Subedi Career Consultancy Services" class="navbar-logo">
        </a>
