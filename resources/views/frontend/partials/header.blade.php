<head>
    ...
    <link href="{{ asset('frontend-assets/custom_css/style.css?v=7.5') }}" rel="stylesheet" />
    <link href="{{ asset('frontend-assets/custom_css/responsive.css?v=7.5') }}" rel="stylesheet" />
