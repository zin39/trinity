<head>
    ...
    <link href="{{ asset('frontend-assets/custom_css/style.css?v=4.0') }}" rel="stylesheet" />
    <link href="{{ asset('frontend-assets/custom_css/responsive.css?v=4.0') }}" rel="stylesheet" />
