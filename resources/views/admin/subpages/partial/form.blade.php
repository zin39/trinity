<fieldset class="mb-3">
    ...
    <div class="form-group row">
        <div class="col-lg-12">
            <div class="row">
                <label class="col-form-label col-lg-12">Short Content:</label>
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <textarea placeholder="Short Content" name="short_content" class="form-control">{{ old('short_content', $page->short_content) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
    ...
    <div class="form-group row">
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <input type="file" accept="image/*" placeholder="Image" name="image" class="form-control">
                    </div>
                </div>
            </div>
        </div>
        @if($page->image)
            <div class="col-lg-12">
                @php
                    $image = ($page->image) ? asset($page->image) : asset('admin/image.png');
                @endphp
                <img id="page_image" src="{{ $image }}" alt="your image" class="preview-image" style="height: 100px;width: auto;" />
            </div>
        @endif
    </div>
