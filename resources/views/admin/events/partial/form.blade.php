            ...
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <input placeholder="Title" name="title" value="{{ old('title', $event->title) }}" class="form-control" required />
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        @php
                            $category_ids = old('category_ids', $event->categories ? $event->categories->pluck('id')->toArray() : []);
                        @endphp
    ...
    <div class="form-group row">
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <textarea placeholder="Content" name="description" class="form-control textarea_description" required>{{ old('description', $event->description) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <input placeholder="Image" id="event_image" type="file" name="banner" class="form-control" {{ ($is_edit ?? false) ? '' : 'required' }} />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <select name="status" class="form-control" required>
                            <option value="1" {{ old('status', $event->status ?? 1) === 1 ? 'selected' : '' }}>Enabled</option>
                            <option value="0" {{ old('status', $event->status) === 0 ? 'selected' : '' }}>Disabled</option>
                        </select>
                    </div>
                </div>
            </div>
    ...
    <div class="form-group row">
        ...
        <div class="col-lg-6">
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    @php
                        $image = ($event->banner) ? asset($event->banner) : asset('admin/image.png');
                    @endphp
                    <a href="{{ $image }}" target="_blank">
                        <img id="event_image" src="{{ $image }}" alt="your image" class="preview-image" style="height: 100px;width: auto;" />
                    </a>
                </div>
            </div>
        </div>
    ...
    <div class="form-group row">
            ...
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <input placeholder="Meta title" name="meta_title" value="{{ old('meta_title', $event->meta_title) }}" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
        <div class="col-lg-6">
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <input placeholder="Meta keywords" name="meta_keywords" value="{{ old('meta_keywords', $event->meta_keywords) }}" class="form-control" />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <textarea placeholder="Meta Description" name="meta_description" class="form-control">{{ old('meta_description', $event->meta_description) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
