            ...
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <input placeholder="Name" name="name" value="{{ old('name', $partner->name) }}" class="form-control" required />
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <input placeholder="Image" id="partner_image" type="file" name="image" class="form-control" {{ ($is_edit ?? false) ? '' : 'required' }} />
                    </div>
                </div>
            </div>
        </div>
        ...
        @if($is_edit ?? false)
            <div class="col-lg-6">
                <div class="row">
                    ...
                    <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                        @php
                            $image = ($partner->image) ? asset($partner->image) : asset('admin/image.png');
                        @endphp
                        <img id="partner_image" src="{{ $image }}" alt="your image" class="preview-image" style="height: 100px;width: auto;" />
                    </div>
                </div>
            </div>
        @endif
    ...
    <div class="form-group row">
        <div class="col-lg-12">
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        <textarea placeholder="Details" name="details" class="form-control textarea_description" required>{{ old('details', $partner->details) }}</textarea>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <input placeholder="Enter Link" type="text" name="link" class="form-control" value="{{ $partner->link }}" />
                    </div>
                </div>
            </div>
        </div>
                ...
                <div class="col-lg-12 form-group-feedback form-group-feedback-right">
                    <div class="input-group">
                        ...
                        <select name="status" class="form-control" required>
                            <option value="1" {{ old('status', $partner->status ?? 1) === 1 ? 'selected' : '' }}>Enabled</option>
                            <option value="0" {{ old('status', $partner->status) === 0 ? 'selected' : '' }}>Disabled</option>
                        </select>
                    </div>
                </div>
            </div>
...
<script type="text/javascript">
    ...
    $(document).ready(function(){
         $('#partner_image').bind('change', function() {
