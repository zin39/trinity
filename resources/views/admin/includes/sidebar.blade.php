            ...
            <ul class="nav nav-sidebar" data-nav-type="accordion">
                ...
                <li class="nav-item nav-item-submenu {{ $menu_active ? 'nav-item-open' : '' }}">
                    ...
                    <ul class="nav nav-group-sub" data-submenu-title="Page Management" style="{{ $menu_active ? 'display: block' : '' }}">
                        ...
                        <li class="nav-item"><a href="{{ route('admin.pages.candidate') }}" class="nav-link @if(($Route[2] ?? '')=='candidate') active @endif" data-popup="tooltip" data-original-title="Candidate" data-placement="right" data-container=".card-sidebar-mobile">Candidate</a></li>
                        <li class="nav-item"><a href="{{ route('admin.pages.employer') }}" class="nav-link @if(($Route[2] ?? '')=='employer') active @endif" data-popup="tooltip" data-original-title="Employer" data-placement="right" data-container=".card-sidebar-mobile">Employer</a></li>
                        <li class="nav-item"><a href="{{ route('admin.pages.testimonials_page') }}" class="nav-link @if(($Route[2] ?? '')=='testimonials_page') active @endif" data-popup="tooltip" data-original-title="Testimonials" data-placement="right" data-container=".card-sidebar-mobile">Testimonials</a></li>
