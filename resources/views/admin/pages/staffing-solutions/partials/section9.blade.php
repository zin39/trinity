    ...
    <div class="card-body">
        <fieldset>
            ...
            <div class="row">
                ...
                <div class="col-lg-12 mb-2">
                    <div class="row">
                        <label class="col-form-label col-lg-3">Button Heading:</label>
                        <div class="col-lg-9 form-group-feedback form-group-feedback-right">
                            <div class="input-group">
                                <span class="input-group-prepend">
                                    <span class="input-group-text"><i class="icon-pencil"></i>
                                ...
                                <input type="text" name='{{ $slug }}[button_heading]' value="{{ old($slug.'.button_heading', $section->button_heading) }}" class='form-control' />
                            </div>
                        </div>
                    </div>
                </div>
