@php
    $section = $sections['healthcare-organizations-membership-previllage'] ? json_decode($sections['healthcare-organizations-membership-previllage']) : null;
...
<div class="card">
    <div class="card-body">
        <form method="POST" class="form-horizontal" enctype= "multipart/form-data" files="true" action="{{route('admin.pages.save-previllages')}}">
            ...
            <div ng-cloak ng-app="Repeater" ng-controller="RepeaterController" ng-init="init({{ json_encode($previllages) }})">
